 ...
 * @author 俞思笳
 */
public class ManagerStu extends javax.swing.JFrame {
    ...
    private void jButton5MouseClicked(MouseEvent e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerStu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
